import SingleLinkedList from "../src/data-structures/SingleLinkedList";

test('Single linked list: should correct add elements', () => {
...
test('Single linked list: should correct delete elements', () => {
...
test('Single linked list: should unshift correctly', () => {
...
test('Single linked list: should shift correctly', () => {
  const testArr = [1,2,3,4,5];
...
test('Single linked list: should pop correctly', () => {
...
test('Single linked list: should peek head and tail correctly', () => {
  const testArr = [0,1,2,3,4,5];
